...
CORS_ALLOW_ALL_ORIGINS = False  # Keep security by explicitly allowing origins
...
if not DEBUG:
    ...
    # Disable SSL redirect to prevent redirect loops when behind a proxy/load balancer
